...
// Simulate the functions with null safety
...
function getTextFormatting(text) {
  ...
  return {
    ...
    className: hasArabic ? 'text-right rtl-content' : 'text-left'
  };
}

function formatBidirectionalText(text) {
  if (!text) return '';
  ...
  if (arabicPattern.test(text)) {
    // If contains Arabic, apply RLM and other formatting
