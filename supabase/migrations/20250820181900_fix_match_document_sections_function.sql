-- Migration: Fix match_document_sections function
-- Created: 2025-08-20 18:19

-- Drop the existing function
DROP FUNCTION IF EXISTS match_document_sections(text, float, int);

-- Create the corrected match_document_sections function
...
COMMENT ON FUNCTION match_document_sections IS 'Performs cosine similarity search on knowledge chunks using JSON arrays (corrected version)';
