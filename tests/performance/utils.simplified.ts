/**
 * Simplified Performance Test Utilities
 * 
 * Helper functions for measuring performance in real-world scenarios
 */
...
export async function cleanupTestData(userId: string) {
  // Delete workouts (cascade will handle workout exercises)
  ...
  // Delete programs
  await prisma.customTrainingProgram.deleteMany({
    where: {
      userId,
      name: {
        contains: 'Performance Test Program',
      },
    },
  });
  ...
  await prisma.programTemplate.deleteMany({
    where: {
      name: {
        contains: 'Performance Test Template',
      },
    },
  });
}
