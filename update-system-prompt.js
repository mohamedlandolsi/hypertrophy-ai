...
const newSystemPrompt = `AI Persona & Core Directives
...
async function updateSystemPrompt() {
  try {
    console.log('🔄 Updating AI configuration with new system prompt...');
    ...
    if (updated) {
      console.log('✅ Successfully updated existing AI configuration');
    } else {
      ...
      console.log('✅ Successfully created new AI configuration');
    }
